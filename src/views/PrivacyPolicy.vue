<template>
    ...
    <div class="alert alert-info">
        ...
        Please be respectful and patient and contact us directly if you have any concerns regarding the privacy policy.
    ...
    <div id='ppBody'>
        ...
        <div>We, along with third-party vendors such as Google use first-party cookies (such as the Google Analytics cookies)
            ...
            data regarding user interactions with ad impressions and other ad service functions as they relate to our website. </div>
        <div><br><strong>Opting out:</strong><br>Users can set preferences for how Google advertises to you using the Google
            Ad Settings page. Alternatively, you can opt out by visiting the Network Advertising Initiative Opt Out page
            or by using the Google Analytics Opt Out Browser add on. Most adblock software blocks Google Analytics.</div>
        ...
        <div class='innerText'>We honor Do Not Track signals and Do Not Track, plant cookies, or use advertising when a Do
            Not Track (DNT) browser mechanism is in place. We don't honor them because it is not handled automatically by Google Analytics
        </div>
    ...
    <div class='innerText'>hitman2maps.com</div>OH
