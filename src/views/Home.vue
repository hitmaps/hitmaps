        ...
        <div class="row dashboard" v-if="games.length > 0 || elusiveTargets.length > 0">
            <div class="game col-lg" v-for="game in games" :key="game.id"
                ...
                <router-link :to="{ name: 'level-select', params: { slug: game.slug }}">
                    ...
                    <div class="game-info">
                        <div class="image">
                            <img :src="'/img/game-icons/' + game.icon + '.png'" class="normal img-fluid"
                                 :alt="game.type + ' Icon'">
                            <img :src="'/img/game-icons/' + game.icon + '-inverted.png'" class="inverted img-fluid"
                                 :alt="game.type + ' Icon'">
                        </div>
                        <div class="text">
                            <h2>{{ game.type }}</h2>
            ...
            <div class="elusive-target col-lg"
                ...
                <router-link @click.native="saveGameData" :to="elusiveTarget.missionUrl" v-if="elusiveTarget != null">
                    ...
                    <div class="countdown">
                        ...
                        <div class="timer"
                             :class="{'not-playable': new Date(elusiveTarget.beginningTime) > new Date()}">
                            <div class="target-arrives">TARGET ARRIVES</div>
                            <countdown class="elusive-countdown"
                                       :date="new Date(elusiveTarget.beginningTime) > new Date() ? elusiveTarget.beginningTime : elusiveTarget.endingTime"></countdown>
                        </div>
                        <img onclick="return false;" @click="showBriefing"
                             src="/img/game-icons/briefing-transparent.png"
                             class="normal img-fluid briefing-icon float-right" alt="Briefing Icon"
                             data-placement="left"
                             data-toggle="tooltip"
                    ...
                    <div class="elusive-target-info">
                        <div class="image">
                            <img src="/img/game-icons/elusive-target.png" class="normal img-fluid"
                                 alt="Elusive Target Icon">
                            <img src="/img/game-icons/elusive-target-inverted.png" class="inverted img-fluid"
                                 alt="Elusive Target Icon">
                        </div>
                        <div class="text">
                        ...
                        <div class="image float-right notification-icon" data-placement="left" data-toggle="tooltip"
                             title="Manage Elusive Target Notifications">
                            <img src="/img/game-icons/notification.png" class="normal img-fluid"
                                 alt="Notification Icon">
                            <img src="/img/game-icons/notification-inverted.png" class="inverted img-fluid"
                                 alt="Notification Icon">
                        </div>
                    </div>
                </router-link>
            ...
            <div ref="briefing" v-if="elusiveTarget != null" class="modal game-modal fade" id="briefing-modal"
                 tabindex="-1" role="dialog" aria-labelledby="briefing-modal-label" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-block btn-secondary" data-dismiss="modal">
                                <img src="/img/game-icons/modal-close.png" class="normal img-fluid"
                                     alt="Notification Icon">
                                <img src="/img/game-icons/modal-close-inverted.png" class="inverted img-fluid"
                                     alt="Notification Icon">
                                Close
                            </button>
                        </div>
