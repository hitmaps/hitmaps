        ...
        <div class="row">
            <div class="col login">
                <div class="login-card">
                    <div v-for="alert in login.messages" :key="alert.type" :class="'alert alert-' + alert.type"
                         role="alert">
                    ...
                    <div class="form-group email row">
                        ...
                        <div class="col-md-9">
                            <input type="email" v-validate name="email" v-model="login.email"
                                   :class="{'is-invalid' : errors.has('login.email'), 'text-danger': errors.has('login.email')}"
                                   class="form-control" id="login-email" placeholder="carlton.smith@example.com"
                                   data-vv-scope="login" required>
                            <span v-show="errors.has('login.email')" class="form-text text-danger">{{errors.first('login.email')}}</span>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="password" class="col-md-3 col-form-label"><i class="fas fa-key"></i>
                            Password</label>
                        <div class="col-md-9">
                            <input type="password" v-validate name="pass" v-model="login.password"
                                   :class="{'is-invalid' : errors.has('login.pass'), 'text-danger': errors.has('login.pass')}"
                                   class="form-control" id="login-password" placeholder="********" data-vv-scope="login"
                                   required>
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6 text-right">
                                    <div class="help-block">
                                        <a href="javascript:" data-toggle="modal" data-target="#forgot-password">I
                    ...
                    <div class="form-group row has-feedback">
                        <div class="col-md-9 offset-md-3">
                            <vue-recaptcha @verify="recaptcha = $event" @expired="recaptcha = ''"
                                           :sitekey="recaptchaSiteKey"></vue-recaptcha>
                            <input type="hidden" class="form-control" name="recaptcha" v-validate v-model="recaptcha"
                                   data-vv-scope="login" required>
            ...
            <div class="col login">
                <div class="login-card">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" id="register-name" placeholder="Carlton Smith"
                                   required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="password" class="form-control" id="register-password" placeholder="********"
                                   minlength="8" data-parsley-error-message="Password must be at least 8 characters"
                                   required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="confirm-password" class="col-md-3 col-form-label"><i class="fas fa-key"></i> Confirm
                            Password</label>
                        <div class="col-md-9">
                            <input type="password" class="form-control" id="register-confirm-password"
                                   placeholder="********" data-parsley-equalto="#password"
                                   data-parsley-error-message="Passwords must match" required>
                            ...
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" name="terms"
                                           data-error="You must agree to the Terms of Use and Privacy Policy" required>
                                    I agree to the <a href="/terms-of-use" target="_blank">Terms of Use</a> and <a
                    ...
                    <div class="form-group row has-feedback">
                        <div class="col-md-9 offset-md-3">
                            ...
                            <input type="hidden" class="form-control" data-parsley-required="true" data-recaptcha="true"
                                   data-parsley-error-message="Please complete the captcha" data-validate="true"
                                   required>
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
