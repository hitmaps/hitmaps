                ...
                <div class="missions">
                    <div class="row" style="margin-left: 15px; margin-right: 15px;">
                        <div v-for="mission in location.missions" :key="mission.id"
                            ...
                            <router-link @click.native="saveMissionData(mission)"
                                         :to="{ name: 'map-view', params: { slug: location.game, location: location.slug, mission: mission.slug, difficulty: mission.difficulties[0].toLowerCase() }}"
                                ...
                                <div class="card mission">
                                    ...
                                    <div class="card-footer">
                                        <div class="image">
                                            <img src="/img/game-icons/mission-inverted.png" class="normal img-fluid"
                                                 alt="Mission Icon">
                                            <img src="/img/game-icons/mission.png" class="inverted img-fluid"
                                                 alt="Mission Icon">
                                        </div>
                                        <div class="text">
                                ...
                                <div style="position: relative">
                                    ...
                                    <div class="card-img-overlay d-flex flex-column justify-content-end"
                                        ...
                                        <div class="row difficulties">
                                            <router-link @click.native="saveMissionData(mission)"
                                                         :to="{ name: 'map-view', params: { slug: location.game, location: location.slug, mission: mission.slug, difficulty: difficulty.toLowerCase() }}"
                                                         v-for="difficulty in mission.difficulties" :key="difficulty"
                                                         class="col">
                                                <div style="padding-top: 10px; padding-bottom: 10px">
                                                    <img :src="'/img/game-icons/' + difficulty.toLowerCase() + '.png'"
                                                         class="normal">
                                                    <img :src="'/img/game-icons/' + difficulty.toLowerCase() + '-inverted.png'"
                                                         class="inverted">
                                                    {{difficulty}}
                                                </div>
                                            </router-link>
