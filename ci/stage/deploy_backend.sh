...
curl https://test.hitman2maps.com/unzip-build.php?zip=backend\&access-key=$ACCESS_KEY
curl https://test.hitman2maps.com/api/admin/migrate?access-key=$ACCESS_KEY
