    ...
    <div class="card">
        <div class="card-header" :id="`header-${uid}`">
            ...
            <div class="visibility-toggle group-toggle"
                ...
                <icon name="fa6-regular:eye" v-if="!areAllNodesHiddenForTopLevelCategory()"/>
                <icon name="fa6-regular:eye-slash" v-else/>
            </div>
        </div>
        <div :id="`body-${uid}`"
             class="collapse"
                ...
                <div v-for="category in categories"
                    ...
                    <div class="name-and-toggle">
                        ...
                        <div v-if="category.collapsible"
                             ...
                             data-bs-toggle="collapse"
                             :data-bs-target="`#${buildCollapsibleId(category)}`">
                            <icon class="caret-up" name="fa6-solid:caret-up"/>
                            <icon class="caret-down" name="fa6-solid:caret-down"/>
                        </div>
                    </div>
