<template>
    <Head>
        <Title>{{ $t('authentication.privacy-policy') }}</Title>
    </Head>
    <div
        class="content"
    ...
    >
        <div class="inner-content">
            ...
            <hr>
            <alert type="info">
                This legal stuff is really a big pain and we would rather focus on
                delivering new features to this site. Please be respectful and
                patient and contact us directly if you have any concerns regarding
...
//region SEO
useSeoMeta({
    ogTitle: () => Utils.siteTitle(t('authentication.privacy-policy'))
});
//endregion
</script>
